...
// DateTimeStyles defines the styles used to render the date/time widget.
type DateTimeStyles struct {
	// InfoStyle is applied to the date/time information text.
	InfoStyle lipgloss.Style
}

// DateTime renders the date/time information widget.
...
func DateTime(subscriptionLabel string, startedAt time.Time, dateFormat string, styles DateTimeStyles) string {
